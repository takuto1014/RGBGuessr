...
rElement = document.querySelector(".R_number");
rElement.addEventListener("change", (event) => {
    changeColor();
});
gElement = document.querySelector(".G_number");
gElement.addEventListener("change", (event) => {
changeColor();
});
bElement = document.querySelector(".B_number");
...
function MyRecord(){
    ...
    if(value==null || value==0){
        ...
        document.getElementById("prerecord").innerText = "前回の記録 単発: "+localStorage.getItem("value"+(value-1))+"点 "
    }
